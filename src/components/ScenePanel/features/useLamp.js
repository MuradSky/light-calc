...
const useLamp = (scene) => {
    ...
    function updateLamps(roomWidth, lampHeight, roomDepth, lampCount, margin = 0) {
    ...
    // Динамически добавляем источники света для каждого светильника
    // addLightsForLamps(lampsPerRow, lampsPerColumn, margin, lampHeight, xStep, zStep, totalLamps);
}
